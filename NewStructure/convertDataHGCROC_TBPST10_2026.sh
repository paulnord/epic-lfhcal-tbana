...
# 44V, summing board V1, new preamp settings 
  ...
  if [ $3 = "convert" ]; then 
    runs='464 463 456 455 454 453 452 461 460 459 458 457 462 463 464' #full list
#     runs='425 427 428 429 430 464 463 456 455 454 453 452 461 460 459 458 457 462 463 464' #full list
  ...
  if [ $3 = "convert" ]; then   
#     runs='075 076 077 093 101 102 103 104 105 112 120 121 122 123 124 125 127 128 129 137 138 172 173 174 175 176 185 186 187 188 191 234 235 236 237 239 243 270 271 272 273 274 275 276 277 278 279 280 281 282 283 284 285 286 298 300 301 303 310 320 325 330 332 333 334 335 336 337 340 348 349 350 371 372 373 374 375 376 377 378 420 421 423 424 426 465 466 467 468'
#     runs='234 191 188 127 128 129 112 093'
#     runs='423 424'
#     runs='286'
    runs='001 002 004 006 007 008 009 010 011 012 013 014 015 016 017 018 019 020 021 '
