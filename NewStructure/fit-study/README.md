...
The reference uses at least 200 midpoint samples per Landau width and at least 4,000 steps. The adjustment uses at least five samples per Landau width, retains the original 100-step minimum, and caps the count at 10,000. This grid stays below the cap. These sheets test numerical sampling, not fit convergence or scientific calibration quality.
