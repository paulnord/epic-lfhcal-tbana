...
hashes of the executable and calibration texts, and histogram path/stat data.
The large source ROOT file is not hashed; each result file contains the actual
input TH1 under `source_histogram`. ROOT/compiler/host and argv are also recorded.
